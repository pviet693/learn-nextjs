...
export async function getServerSideProps(context: GetServerSidePropsContext) {
    // gọi getServerSideProps và cache trong CDN
    // trong vòng 5s tiếp theo sẽ trả về dữ liệu ngay lập tức trong CDN
    // sau 5s đó, sẽ trả về dữ liệu đã cache trong CDN, sau đó gọi getServerSideProps và cache trong CND
    // ...
